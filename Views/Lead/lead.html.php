...
<div class="col-md-2 bg-white bdr-r height-auto">
<?php echo $view['content']->getCustomContent('section.left', $mauticTemplateVars); ?>
</div>
    <!-- left section -->
    <div class="col-md-9 bg-white height-auto">
        ...
        <div class="bg-auto bg-dark-xs">
            ...
            <?php endif; ?>
            <?php echo $view['content']->getCustomContent('section.center', $mauticTemplateVars); ?>
            <?php echo $view['content']->getCustomContent('section.tabs', $mauticTemplateVars); ?>
            
    </div>
    <!--/ left section -->

    <!-- right section -->
    <div class="col-md-2 bg-white bdr-l height-auto">
        <!-- form HTML -->
       
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mb-0">
        <?php echo $view['content']->getCustomContent('section.right', $mauticTemplateVars); ?>
            <?php if (false):// (!$lead->isAnonymous()): ?>
